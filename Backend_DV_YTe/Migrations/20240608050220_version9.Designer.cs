...
namespace Backend_DV_YTe.Migrations
{
    ...
    [Migration("20240608050220_version9")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_DV_YTe.Entity.DiaChiEntity", b =>
                {
                    ...
                    b.Property<int>("NhanVienmaKhachHang")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("NhanVienmaKhachHang");

                    b.ToTable("diaChiEntities");
                });
            ...
            modelBuilder.Entity("Backend_DV_YTe.Entity.DiaChiEntity", b =>
                {
                    b.HasOne("Backend_DV_YTe.Entity.KhachHangEntity", "NhanVien")
                        .WithMany("DiaChi")
                        .HasForeignKey("NhanVienmaKhachHang")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
