...
namespace Backend_DV_YTe.Migrations
{
    ...
    [Migration("20240705052619_version27")]
    partial class version27
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_DV_YTe.Entity.HuyLoThietBiYTeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LoThietBiId");

                    b.ToTable("HuyLoThietBiYTe");
                });

            modelBuilder.Entity("Backend_DV_YTe.Entity.HuyLoThuocEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend_DV_YTe.Entity.HuyLoThietBiYTeEntity", b =>
                {
                    b.HasOne("Backend_DV_YTe.Entity.LoThietBiYTeEntity", "LoThietBiYTe")
                        .WithMany("HuyLoThietBiYTe")
                        .HasForeignKey("LoThietBiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoThietBiYTe");
                });
