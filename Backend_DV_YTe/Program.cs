...
//builder.Services.AddScoped<IThanhToanDVRepository, ThanhToanDVRepository>();
...
builder.Services.AddHostedService<ExpiringLoThuocChecker>();
...
builder.Services.AddScoped<IDiaChiRepository, DiaChiRepository>();
builder.Services.AddScoped<ILichLamViecRepository, LichLamViecRepository>();
builder.Services.AddScoped<ILoThuocRepository, LoThuocRepository>();
builder.Services.AddScoped<ILoThietBiYTeRepository, LoThietBiYTeRepository>();
//======================================
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowAll", builder =>
    {
        builder.WithOrigins("http://levi123-001-site1.ktempurl.com", "http://localhost:3000")
               .AllowAnyMethod()
               .AllowAnyHeader();
    });
});
...
app.UseHttpsRedirection();
app.UseCors("AllowAll"); // Sử dụng chính sách CORS "AllowAll"
app.UseAuthentication();// de ra 401
app.UseAuthorization();
